...
if 'val_metrics' not in st.session_state:
...
<style>
    ...
    .main-header {
        background: linear-gradient(135deg, #4FC3F7, #29B6F6); /* Light blue gradient */
        padding: 2rem;
        border-radius: 10px;
        margin-bottom: 2rem;
    ...
    .stButton > button:hover {
        background-color: #4FC3F7; /* Lighter blue hover */
    }
    ...
    .info-card {
        background: #E3F2FD; /* Light blue-tinted background */
        color: #000000;
        padding: 1.5rem;
        border-radius: 10px;
...
st.sidebar.title("AGRONOMIC")
menu = st.sidebar.radio("Navigation", ["Overview","About","Sample", "Disease Detection", "Data", "Test Data & Outputs"])
...
def classify_severity(area_ratio):
    if area_ratio < 0.01:
        ...
        return "Moderate Infection"
    elif area_ratio >0.05 and area_ratio <=0.64:
        return "Severe Infection"
    else:
        print(f"hello here is it {area_ratio}")
        return "No Infection"
...
if menu == "Overview":
    ...
    st.markdown("""
    <div style="background: linear-gradient(135deg, #4FC3F7, #29B6F6);; padding: 2rem; border-radius: 10px; text-align: center; margin-top: 2rem; color: white;">
    ...
    st.markdown(
        """
        ---
        <p style="text-align:center; color:#29B6F6; font-weight:bold;">
        Use the sidebar to navigate through Disease Detection, Test Images, and Outputs.
        </p>
        """,
        unsafe_allow_html=True
    ...
    if image:
        ...
        if st.button("🔍 Run Disease Detection"):
            ...
            if detected_classes:
                ...
                if predicted_disease == "Healthy":
                    severity = "None"
                elif predicted_disease == "Late_blight":
...
# -------------------------------
# Test Data & Outputs (FIXED & SAFE)
elif menu == "Test Data & Outputs":
    st.title("Test Data & Outputs")
    st.write("Model evaluation results and performance metrics on validation set.")
    ...
    def run_validation():
        st.write("Running validation on validation set... (this runs only once)")
        metrics = model.val(data='data.yaml', split='val', plots=True, save=True)
        return metrics
    ...
    if not st.session_state.validation_done:
        ...
        metrics = st.session_state.val_metrics
        st.info("Using cached validation results.")
    box_metrics = metrics.box
    ...
    st.subheader("📈 Evaluation Metrics/Plots Images")
    eval_metric_images = []
    ...
    st.markdown('<h1 class="section-header">About AGRONOMIC</h1>', unsafe_allow_html=True)
    ...
    with col1:
        ...
        <div class="info-card">
            ...
            <p>AGRONOMIC was developed to provide farmers and gardeners with a quick, reliable tool for identifying tomato plant diseases. By leveraging artificial intelligence and computer vision, we aim to help reduce crop losses and promote sustainable farming practices.</p>
        </div>
        
        <div class="info-card">
            <h3 style="color:#000000;">Technology</h3>
            <p>Our application uses a YOLOv8 deep learning model trained on a dataset of thousands of tomato leaf images. The model can accurately detect and classify 5 different conditions, including 4 common tomato leaf diseases and healthy leaves.</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    <div class="info-card" style="margin-top: 2rem;">
        ...
        <p>We're constantly working to improve our disease detection accuracy. If you have suggestions or feedback, please contact us at </b> greatestangel2002@gmail.com</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    disease_images = {
        "Early Blight": "images/early_blight.jpg",
        "Late Blight": "images/late_blight.jpg",
        "Leaf Mold": "images/leaf_mold.jpg",
        "Healthy": "images/healthy.jpg",
        "Bacterial Spot": "images/bacterial_spot.jpg",
        "Leaf Mold": "images/leaf_mold.jpg",
        "black spot": "images/black_spot.jpg",
    ...
    for i, disease in enumerate(diseases):
        ...
        with col1 if i % 2 == 0 else col2:
            ...
            image_path = disease_images.get(disease, "images/default.jpg") 
